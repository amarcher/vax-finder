...
function Disclaimer() {
  return (
    <div className="disclaimer">
      <p className="disclaimer__last_updated">
      ...
      <ul>
        <li>
          <p>
            ...
            Disclaimer) refers to Vax-Finder.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>You</strong>
            <span>&nbsp;</span>
            means the individual accessing the Service, or the company, or other
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>
            refers to this site, accessible form
            <span>&nbsp;</span>
            <a
              href="https://vax-finder.herokuapp.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://vax-finder.herokuapp.com/
            </a>
          </p>
        </li>
      </ul>
